...
public class GlobalService {
    ...
    /**
     * Retrieves a JSON node containing information about people living at a given
     * fire station number,
     * including the number of children living at the station.
     *
     * @param stationNumber the number of the fire station to retrieve information
     *                      for
     * @return a JSON node containing the following information:
     *         - "people": an array of JSON objects representing each person living
     *         at the station,
     *         with each object containing the person's first name, last name,
     *         address,
     *         and age
     ...
     */
    public PersonFirestrationDTO getFirestationByFirestationNumber(String stationNumber)
        ...
        for (Person person : persons) {
            Medicalrecord medicalrecord = medicalrecordRepository
                    .getMedicalrecordByNames(person.firstName, person.lastName).orElseThrow();
     ...
     * @return a JSON node containing information about children living at the
     *         address
     */
    ...
    /**
     * Retrieves a JSON node containing a list of phone numbers of people living at
     * a given fire station number.
     *
     * @param fireStationNumber the number of the fire station to retrieve phone
     *                          numbers for
    ...
    public List<String> gethPhoneAlert(String fireStationNumber) throws JsonProcessingException, IOException {
        ...
        for (String address : adresses) {
            concernedPhone
                    .addAll(personRepository.getPersonsByAdress(address).stream().map(person -> person.phone).toList());
        }
    ...
    /**
     * Retrieves a JSON node containing information about people living at a given
     * address and the fire station at that address.
     *
     ...
     *         - "firestation": a string representing the fire station at the
     *         address
     * @throws IOException if there is an I/O error
     */
    ...
    /**
     * Retrieves a JSON node containing information about people living at certain
     * addresses based on station numbers.
     *
    ...
    /**
     * Retrieves a JSON node containing information about people with a specific
     * last name.
     *
     * @param lastName the last name to search for
     * @return a JSON node containing information about persons with the specified
     *         last name
     * @throws IOException if there is an I/O error
     */
    ...
    /**
     * Retrieves a JSON node containing email addresses of people living in the
     * specified city.
     *
